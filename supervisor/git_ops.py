...
# load_state/save_state (and, after the rescue slice, append_jsonl and
# atomic_write_text) are parent bindings the G1 leaves read through the
# call-time handle _go() and tests monkeypatch on this module — they must stay
