...
- Update your scratchpad, identity, or self (`update_scratchpad` / `update_identity` / `update_self`), and keep the knowledge base current
...
Read `memory/dialogue_meta.json`, `memory/scratchpad.md`, `memory/identity.md`,
and `memory/self.md` first. That tells you what's stale. Then pick the most
urgent item.
