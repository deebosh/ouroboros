...
[![Version 6.111.1](https://img.shields.io/badge/version-6.111.1-green.svg)](VERSION)
...
[download-macos-arm64]: https://github.com/razzant/ouroboros/releases/download/v6.111.1/Ouroboros-6.111.1.dmg
[download-windows-x64]: https://github.com/razzant/ouroboros/releases/download/v6.111.1/Ouroboros-6.111.1-windows-x64.zip
[download-linux-deb-amd64]: https://github.com/razzant/ouroboros/releases/download/v6.111.1/ouroboros_6.111.1_amd64.deb
[download-linux-rpm-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.111.1/ouroboros-6.111.1-1.x86_64.rpm
[download-linux-rpm-red80-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.111.1/ouroboros-6.111.1-1.red80.x86_64.rpm
[download-linux-appimage-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.111.1/Ouroboros-6.111.1-linux-x86_64.AppImage
[download-linux-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.111.1/Ouroboros-6.111.1-linux-x86_64.tar.gz
...
|---------|------|-------------|
| 6.111.1 | 2026-09-02 | merge upstream v6.111.0: absorb LLM-call observability + reviewed-mutative-tool timeout refactor, actor-first terminal projection, session verdict deadline plumbing, project-thread broadcast stamping; re-thread fork hardening (work_uncommitted enforcement, cross-check, #129 ledger warm cache, preflight root hint, session-isolation) |
