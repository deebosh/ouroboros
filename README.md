...
[![Version 7.0.0-rc.10](https://img.shields.io/badge/version-7.0.0--rc.10-green.svg)](VERSION)
...
[download-macos-arm64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.10/Ouroboros-7.0.0-rc.10.dmg
[download-windows-x64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.10/Ouroboros-7.0.0-rc.10-windows-x64.zip
[download-linux-deb-amd64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.10/ouroboros_7.0.0-rc.10_amd64.deb
[download-linux-rpm-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.10/ouroboros-7.0.0-rc.10-1.x86_64.rpm
[download-linux-rpm-red80-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.10/ouroboros-7.0.0-rc.10-1.red80.x86_64.rpm
[download-linux-appimage-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.10/Ouroboros-7.0.0-rc.10-linux-x86_64.AppImage
[download-linux-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.10/Ouroboros-7.0.0-rc.10-linux-x86_64.tar.gz
...
|---------|------|-------------|
| 7.0.0-rc.10 | 2026-09-04 | **Release candidate of 7.0.0 — hotfix of the rc.9 tag CI.** Six absorbed upstream tests are adapted to the 7.0 tree and to Windows (the shipped triad defaults are read from their settings_defaults SSOT instead of the retired OUROBOROS_REVIEW_MODELS key; Windows-safe path, JSON-escaping and subprocess-decoding contracts), so the 3-OS full-test and the benchmark-methodology job are green again and packaged pre-release artifacts are built. Runtime changes only where a contract was OS-dependent (see the commit log rc.9..rc.10). |
