...
[![Version 6.109.6](https://img.shields.io/badge/version-6.109.6-green.svg)](VERSION)
...
[download-macos-arm64]: https://github.com/razzant/ouroboros/releases/download/v6.109.6/Ouroboros-6.109.6.dmg
[download-windows-x64]: https://github.com/razzant/ouroboros/releases/download/v6.109.6/Ouroboros-6.109.6-windows-x64.zip
[download-linux-deb-amd64]: https://github.com/razzant/ouroboros/releases/download/v6.109.6/ouroboros_6.109.6_amd64.deb
[download-linux-rpm-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.109.6/ouroboros-6.109.6-1.x86_64.rpm
[download-linux-rpm-red80-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.109.6/ouroboros-6.109.6-1.red80.x86_64.rpm
[download-linux-appimage-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.109.6/Ouroboros-6.109.6-linux-x86_64.AppImage
[download-linux-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.109.6/Ouroboros-6.109.6-linux-x86_64.tar.gz
...
|---------|------|-------------|
| 6.109.6 | 2026-08-30 | **Patch (ibl-local-29ee0d0e37bc)** — Sanctioned size-ratchet manifest update path. The shell auto-restore now preserves a clean size-ratchet manifest update (validated against HEAD's committed authority via `review.validate_size_ratchet`) instead of reverting it. Multi-dirty or invalid manifests still revert as before. |
