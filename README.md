...
[![Version 6.103.9](https://img.shields.io/badge/version-6.103.9-green.svg)](VERSION)
...
| 6.103.5 | 2026-08-16 | Remove dead code in ouroboros/tools/shell.py: _tree_fingerprint (unbounded rglob hash, superseded by the bounded fingerprint helpers already in use) and _get_diff_stat, both unused since v6.3.0-rc.2. |
