...
|---------|------|-------------|
| 6.113.5 | 2026-09-02 | merge upstream v6.113.4 (120 commits): verdict-canonicalization module split (review_verdict_extraction), advisory native-route credential gate, atlas render-cost accounting; re-thread fork cross-check + required_in_full atlas tiering + readiness-warnings + bump_version tool |
