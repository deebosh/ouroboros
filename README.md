...
[![Version 7.0.0-rc.9](https://img.shields.io/badge/version-7.0.0--rc.9-green.svg)](VERSION)
...
[download-macos-arm64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.9/Ouroboros-7.0.0-rc.9.dmg
[download-windows-x64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.9/Ouroboros-7.0.0-rc.9-windows-x64.zip
[download-linux-deb-amd64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.9/ouroboros_7.0.0-rc.9_amd64.deb
[download-linux-rpm-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.9/ouroboros-7.0.0-rc.9-1.x86_64.rpm
[download-linux-rpm-red80-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.9/ouroboros-7.0.0-rc.9-1.red80.x86_64.rpm
[download-linux-appimage-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.9/Ouroboros-7.0.0-rc.9-linux-x86_64.AppImage
[download-linux-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.9/Ouroboros-7.0.0-rc.9-linux-x86_64.tar.gz
...
|---------|------|-------------|
| 7.0.0-rc.9 | 2026-09-04 | **Release candidate of 7.0.0 — the v7 follow-up sprint, phase F2 (upstream absorption).** The frozen upstream `ouroboros` line (407 commits: budget rail, acceptance packet and floor, DeepSeek provider, live-card naming, chat-identity routing, skills gateway and widgets, shell write guards, native review episode bound, model defaults) is merged into the v7 module split as one merge commit plus two reviewed fix batches; every upstream change lands in v7's owning leaf, retired 7.0 surfaces stay retired, docs rebuilt on upstream's text with compact v7 deltas, the system-E2E lane follows upstream's admission and custody-debt semantics (S21/S25), and a keyless scenario proves the owner stop of a live direct chat turn (S26). |
