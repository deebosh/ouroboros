...
[![Version 7.0.0-rc.1](https://img.shields.io/badge/version-7.0.0--rc.1-green.svg)](VERSION)
...
[download-macos-arm64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.1/Ouroboros-7.0.0-rc.1.dmg
[download-windows-x64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.1/Ouroboros-7.0.0-rc.1-windows-x64.zip
[download-linux-deb-amd64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.1/ouroboros_7.0.0-rc.1_amd64.deb
[download-linux-rpm-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.1/ouroboros-7.0.0-rc.1-1.x86_64.rpm
[download-linux-rpm-red80-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.1/ouroboros-7.0.0-rc.1-1.red80.x86_64.rpm
[download-linux-appimage-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.1/Ouroboros-7.0.0-rc.1-linux-x86_64.AppImage
[download-linux-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.1/Ouroboros-7.0.0-rc.1-linux-x86_64.tar.gz
...
|---------|------|-------------|
| 7.0.0-rc.1 | 2026-09-02 | **Release candidate of 7.0.0** — packaged pre-release for the owner's manual test (batch №13 item 14); runtime identical to the 7.0.0 candidate. The release bar now runs `system-e2e-mock`, the cancellation E-suite mock lane and the campaign `--release` gate on the tag path itself. |
