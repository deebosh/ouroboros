...
[![Version 7.0.0-rc.11](https://img.shields.io/badge/version-7.0.0--rc.11-green.svg)](VERSION)
...
[download-macos-arm64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.11/Ouroboros-7.0.0-rc.11.dmg
[download-windows-x64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.11/Ouroboros-7.0.0-rc.11-windows-x64.zip
[download-linux-deb-amd64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.11/ouroboros_7.0.0-rc.11_amd64.deb
[download-linux-rpm-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.11/ouroboros-7.0.0-rc.11-1.x86_64.rpm
[download-linux-rpm-red80-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.11/ouroboros-7.0.0-rc.11-1.red80.x86_64.rpm
[download-linux-appimage-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.11/Ouroboros-7.0.0-rc.11-linux-x86_64.AppImage
[download-linux-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.11/Ouroboros-7.0.0-rc.11-linux-x86_64.tar.gz
...
| 7.0.0-rc.10 | 2026-09-04 | **Release candidate of 7.0.0 — hotfix of the rc.9 tag CI.** Six absorbed upstream tests are adapted to the 7.0 tree and to Windows (the shipped triad defaults are read from their settings_defaults SSOT instead of the retired OUROBOROS_REVIEW_MODELS key; Windows-safe path, JSON-escaping and subprocess-decoding contracts), so the benchmark-methodology job and the four Windows tests are green again; the rc.10 tag CI still failed on Windows in a serial-lane suite that had never run there (fixed in rc.11), so rc.10 built no packaged artifacts. Runtime changes only where a contract was OS-dependent (see the commit log rc.9..rc.10). |
