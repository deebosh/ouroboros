...
[![Version 7.0.0-rc.4](https://img.shields.io/badge/version-7.0.0--rc.4-green.svg)](VERSION)
...
[download-macos-arm64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.4/Ouroboros-7.0.0-rc.4.dmg
[download-windows-x64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.4/Ouroboros-7.0.0-rc.4-windows-x64.zip
[download-linux-deb-amd64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.4/ouroboros_7.0.0-rc.4_amd64.deb
[download-linux-rpm-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.4/ouroboros-7.0.0-rc.4-1.x86_64.rpm
[download-linux-rpm-red80-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.4/ouroboros-7.0.0-rc.4-1.red80.x86_64.rpm
[download-linux-appimage-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.4/Ouroboros-7.0.0-rc.4-linux-x86_64.AppImage
[download-linux-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.4/Ouroboros-7.0.0-rc.4-linux-x86_64.tar.gz
...
|---------|------|-------------|
| 7.0.0-rc.4 | 2026-09-03 | **Release candidate of 7.0.0** — packaged pre-release for the owner's manual test (batch №13 item 14); rc.1 never built (bundle step), rc.2/rc.3 stopped at one Windows test pin each (the kernel tier's Windows executions otherwise green). Carries the W4 crash-window fixes and typed process facts on the five remaining surfaces. Carries the Windows kernel lock tier (item 1 = B) and the split compaction suite. The release bar now runs `system-e2e-mock`, the cancellation E-suite mock lane and the campaign `--release` gate on the tag path itself. |
