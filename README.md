...
[![Version 6.103.13](https://img.shields.io/badge/version-6.103.13-green.svg)](VERSION)
...
|---------|------|-------------|
| 6.103.13 | 2026-08-18 | Class-fix for `ibl-rot-fix-paths-attr-blocked`: `commit_reviewed(paths=[...])` now honors an explicit clean-at-baseline subset when the sole blocker is unrelated `preexisting_dirty_changed`; omitted paths still fail-closed, empty list remains no-op, evidence preserved unchanged. |
