...
[![Version 6.103.2](https://img.shields.io/badge/version-6.103.2-green.svg)](VERSION)
...
|---------|------|-------------|
| 6.103.2 | 2026-08-16 | Add owner Settings UI for task idle timeout, task absolute ceiling, web-search backend, and main-chat web search — all were real, already-functional settings with zero UI surface. |
