...
[![Version 6.103.4](https://img.shields.io/badge/version-6.103.4-green.svg)](VERSION)
...
|---------|------|-------------|
| 6.103.4 | 2026-08-16 | Fix compute_complexity_metrics undercounting multi-line function signatures (Black-style closing paren at column 0), which silently blinded the codebase_health self-assessment tool across ~176 files. |
