...
[![Version 6.103.3](https://img.shields.io/badge/version-6.103.3-green.svg)](VERSION)
...
|---------|------|-------------|
| 6.103.3 | 2026-08-16 | Split _repo_commit_push (324 lines, over the 300-line function gate) into three helpers — no behavior change, pure P2 extraction. |
