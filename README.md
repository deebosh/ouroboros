...
[![Version 7.0.0-rc.13](https://img.shields.io/badge/version-7.0.0--rc.13-green.svg)](VERSION)
...
[download-macos-arm64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.13/Ouroboros-7.0.0-rc.13.dmg
[download-windows-x64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.13/Ouroboros-7.0.0-rc.13-windows-x64.zip
[download-linux-deb-amd64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.13/ouroboros_7.0.0-rc.13_amd64.deb
[download-linux-rpm-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.13/ouroboros-7.0.0-rc.13-1.x86_64.rpm
[download-linux-rpm-red80-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.13/ouroboros-7.0.0-rc.13-1.red80.x86_64.rpm
[download-linux-appimage-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.13/Ouroboros-7.0.0-rc.13-linux-x86_64.AppImage
[download-linux-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.13/Ouroboros-7.0.0-rc.13-linux-x86_64.tar.gz
...
|---------|------|-------------|
| 7.0.0-rc.13 | 2026-09-05 | **Release candidate of 7.0.0 — hotfix of the rc.12 tag CI.** The rc.12 tag's full-test was red on every OS in one test module: a started-and-never-stopped test patch of the network-password resolver on a shared xdist worker made the gate answer the empty password for every later module. The leaking test (the skill-toggle actor test) now stops the patches it starts. An autouse guard in the root conftest names any test that leaves the resolver patched and restores it, so the victim modules can no longer fail by worker ordering; the live stand's 0600 template-mode pin is POSIX-only (Windows chmod toggles read-only and reads 0o666 — the redaction is the guarantee there). |
