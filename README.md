...
[![Version 6.110.2](https://img.shields.io/badge/version-6.110.2-green.svg)](VERSION)
...
[download-macos-arm64]: https://github.com/razzant/ouroboros/releases/download/v6.110.2/Ouroboros-6.110.2.dmg
[download-windows-x64]: https://github.com/razzant/ouroboros/releases/download/v6.110.2/Ouroboros-6.110.2-windows-x64.zip
[download-linux-deb-amd64]: https://github.com/razzant/ouroboros/releases/download/v6.110.2/ouroboros_6.110.2_amd64.deb
[download-linux-rpm-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.110.2/ouroboros-6.110.2-1.x86_64.rpm
[download-linux-rpm-red80-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.110.2/ouroboros-6.110.2-1.red80.x86_64.rpm
[download-linux-appimage-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.110.2/Ouroboros-6.110.2-linux-x86_64.AppImage
[download-linux-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.110.2/Ouroboros-6.110.2-linux-x86_64.tar.gz
...
|---------|------|-------------|
| 6.110.2 | 2026-09-02 | remove owner-configurable per-task-type LLM sampling temperature feature (3bbe8656 + follow-ups): drop temperature_settings.py, POST /api/owner/temperature, /api/state temperatures field + contract, config keys (retired), loop/loop_llm_call plumbing |
| 6.110.1 | 2026-09-02 | merge upstream v6.110.0: adopt read_unconsolidated_chat + governance/identity-source consciousness + atomic attachment staging; re-thread fork features (drop-priority degradation, cross-check, section-sizes event, protected-path restore, archive-before-drop, pin-aware eviction) |
