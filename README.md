...
[![Version 7.0.0-rc.17](https://img.shields.io/badge/version-7.0.0--rc.17-green.svg)](VERSION)
...
[download-macos-arm64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.17/Ouroboros-7.0.0-rc.17.dmg
[download-windows-x64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.17/Ouroboros-7.0.0-rc.17-windows-x64.zip
[download-linux-deb-amd64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.17/ouroboros_7.0.0-rc.17_amd64.deb
[download-linux-rpm-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.17/ouroboros-7.0.0-rc.17-1.x86_64.rpm
[download-linux-rpm-red80-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.17/ouroboros-7.0.0-rc.17-1.red80.x86_64.rpm
[download-linux-appimage-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.17/Ouroboros-7.0.0-rc.17-linux-x86_64.AppImage
[download-linux-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.17/Ouroboros-7.0.0-rc.17-linux-x86_64.tar.gz
...
|---------|------|-------------|
| 7.0.0-rc.17 | 2026-09-08 | **Fix-forward candidate: make the cancellation E2E stub recognize multipart finalization markers consistently across provider wire shapes.** |
| 7.0.0-rc.16 | 2026-09-08 | **Release candidate of 7.0.0 — reviewed model-wait and subscription routing, account-role controls, MCP decision-lane capability, safer owned-daemon restart custody, scratchpad/evidence disclosure, and cross-platform lock fixes. Claudexor is pinned to 3.10.0.** |
