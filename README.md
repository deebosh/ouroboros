...
[![Version 6.109.29](https://img.shields.io/badge/version-6.109.29-green.svg)](VERSION)
...
[download-macos-arm64]: https://github.com/razzant/ouroboros/releases/download/v6.109.29/Ouroboros-6.109.29.dmg
[download-windows-x64]: https://github.com/razzant/ouroboros/releases/download/v6.109.29/Ouroboros-6.109.29-windows-x64.zip
[download-linux-deb-amd64]: https://github.com/razzant/ouroboros/releases/download/v6.109.29/ouroboros_6.109.29_amd64.deb
[download-linux-rpm-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.109.29/ouroboros-6.109.29-1.x86_64.rpm
[download-linux-rpm-red80-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.109.29/ouroboros-6.109.29-1.red80.x86_64.rpm
[download-linux-appimage-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.109.29/Ouroboros-6.109.29-linux-x86_64.AppImage
[download-linux-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.109.29/Ouroboros-6.109.29-linux-x86_64.tar.gz
...
|---------|------|-------------|
| 6.109.29 | 2026-09-01 | fix(logs): events.jsonl + tools.jsonl now rotate on the supervisor tick via the generalized rotator; SSE follower archive-chain-aware for both (closes ibl-86f8b98069e8 / razzant#132) |
| 6.109.28 | 2026-09-01 | docs(review-continuity): document missing-result retirement and periodic sweep |
| 6.109.27 | 2026-09-01 | fix(review-continuity): retire_settled_continuations also archives abandoned (no-result) records past 3x the settle floor + a ~6h periodic sweep; .ouroboros/ gitignored (closes ibl-a7953bc2c2b7) |
| 6.109.26 | 2026-09-01 | fix(consolidator): a transient empty/non-JSON model reply defers cleanly instead of erroring the whole pass; context.py downgrades the recoverable dialogue-offset-ignored log to INFO (closes ibl-28109914789e) |
| 6.109.25 | 2026-09-01 | fix(backlog): tag nominated items with referent_status (verified/unverified/partial/none) and downgrade a high-priority item whose named code referents do not resolve, so phantom IBLs stop burning worker rounds (closes ibl-74bd59bab040) |
