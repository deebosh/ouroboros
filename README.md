...
[![Version 6.103.11](https://img.shields.io/badge/version-6.103.11-green.svg)](VERSION)
...
|---------|------|-------------|
| 6.103.11 | 2026-08-17 | Add check_worker_memory() health invariant to detect worker memory bloat rot (closes ibl-worker-memory-bloat). |
