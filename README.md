...
[![Version 6.103.1](https://img.shields.io/badge/version-6.103.1-green.svg)](VERSION)
...
|---------|------|-------------|
| 6.103.1 | 2026-08-16 | Add owner Settings toggle for Reasoning Narration (OUROBOROS_REASONING_SUMMARY auto/off) — the setting already existed, only the UI was missing. |
