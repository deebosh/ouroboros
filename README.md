...
[![Version 7.0.0-rc.3](https://img.shields.io/badge/version-7.0.0--rc.3-green.svg)](VERSION)
...
[download-macos-arm64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.3/Ouroboros-7.0.0-rc.3.dmg
[download-windows-x64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.3/Ouroboros-7.0.0-rc.3-windows-x64.zip
[download-linux-deb-amd64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.3/ouroboros_7.0.0-rc.3_amd64.deb
[download-linux-rpm-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.3/ouroboros-7.0.0-rc.3-1.x86_64.rpm
[download-linux-rpm-red80-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.3/ouroboros-7.0.0-rc.3-1.red80.x86_64.rpm
[download-linux-appimage-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.3/Ouroboros-7.0.0-rc.3-linux-x86_64.AppImage
[download-linux-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.0-rc.3/Ouroboros-7.0.0-rc.3-linux-x86_64.tar.gz
...
|---------|------|-------------|
| 7.0.0-rc.3 | 2026-09-03 | **Release candidate of 7.0.0** — packaged pre-release for the owner's manual test (batch №13 item 14); rc.1 never built (bundle step), rc.2 stopped at one Windows text pin (the kernel tier's first Windows execution otherwise green). Carries the Windows kernel lock tier (item 1 = B) and the split compaction suite. The release bar now runs `system-e2e-mock`, the cancellation E-suite mock lane and the campaign `--release` gate on the tag path itself. |
