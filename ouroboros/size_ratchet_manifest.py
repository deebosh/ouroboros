...
BAND_PATHS = {
    ...
    "tests/test_extension_companion.py": "Entered the band at 1061 from 999 with the lock-ordering regression test (companion processes start outside the registry lock; a start failure still routes to unload) and the call-site rewiring to extension_companion.companion_spawn_env.",
