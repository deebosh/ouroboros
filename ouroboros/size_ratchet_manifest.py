...
GIANT_PATHS = (
    ...
    "tests/test_update_merge_assisted.py",
...
FUNCTION_DEBT = (
    ...
    ("ouroboros/agent_task_pipeline.py", "emit_task_results"),
    ("ouroboros/gateway/router.py", "collect_routes"),
...
BAND_PATHS = {
    ...
    "ouroboros/consolidator.py": "v7 merge carries the fork's larger consolidator (1068 gated lines at 20017574 vs upstream's 862); union with upstream's edits keeps it in the band, no new growth of substance.",
    ...
    "ouroboros/headless.py": "Net SHRINK: was a fork GIANT (1677 gated lines at 20017574); the merge takes upstream's leaner headless plus the fork's prune_task_results (#139) tail, landing at 1017 \u2014 band re-entry is the reduction's residue.",
    ...
    "ouroboros/outcomes.py": "Both parents band-resident (fork 1433, upstream 1591); the merged union of the two outcome-classification deltas sits at 1458, below both.",
    ...
    "ouroboros/shell_parse.py": "Entered the band in the merge (fork 819, upstream 821): the union of the fork's and upstream's independent shell argv/parse work crosses 1000; the fork's normalize_run_command_argv chain is present but unwired.",
    ...
    "ouroboros/tools/parallel_review.py": "Merge union of the fork's and upstream's parallel-review additions (fork 865, upstream 988) crosses 1000 at 1050.",
    ...
    "tests/test_mcp_client.py": "Union of both parents' MCP client suites (fork 848, upstream 995); this session's stdio-transport reconciliation net-removed ~214 lines and it still lands at 1135.",
    "tests/test_mutation_attribution.py": "v7 merge carries the fork's larger suite (1048 gated lines at 20017574 vs upstream's 882); union keeps it band-resident at 1081.",
    ...
    "tests/test_update_apply_routing.py": "v7 merge carries the fork's larger suite (1027 gated lines at 20017574 vs upstream's 841); union keeps it band-resident at 1038.",
    ...
    "web/modules/settings_ui.js": "v7 merge carries the fork's larger settings UI (1077 gated lines at 20017574 vs upstream's 968) plus the Qwen provider card; 1047.",
...
BYTE_DEBT = {
    ...
    "tests/test_scope_review.py": 207582,
