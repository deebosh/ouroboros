...
BAND_PATHS = {
    ...
    "ouroboros/config.py": "Configuration remains the single public import surface for structural daemon wait defaults owned by settings_defaults; the existing facade re-exports four constants without adding lifecycle or storage authority.",
