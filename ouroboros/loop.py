...
def _build_host_acceptance_evidence(ctx: _TaskAcceptanceContext) -> Dict[str, Any]:
    ...
    # ones judged. Bounded here (attached AFTER the builder's budget pass) and
    # excluded from `task_acceptance_evidence_revision`, so growing history can
    # never mint a fresh paid binding.
