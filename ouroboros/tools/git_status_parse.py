"""Git-status/porcelain path parsing — split out of review_helpers.py (module-size gate).

Pure text/bytes parsing with one bounded subprocess call; no review-stack dependencies,
so this has no circular-import constraint the way review_helpers.py does with review.py.
"""
