...
as the binding description of what the skill is allowed to touch. Skills
must not write to the self-modifying repo, and reviewed execution is the
primary gate: Section 13 owns the payload/data-plane boundary and
invariant 8 keeps the skill gates independent.
