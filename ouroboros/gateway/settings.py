...
_IMMEDIATE_KEYS = frozenset({
    ...
    "OUROBOROS_UPDATE_AUTOCHECK_ENABLED",
    "OUROBOROS_UPDATE_AUTOCHECK_INTERVAL_SEC",
    "OUROBOROS_UPDATE_SEMANTIC_TIMEOUT_SEC",
    "OUROBOROS_REASONING_SUMMARY",
    "OUROBOROS_TASK_IDLE_TIMEOUT_SEC",
    "OUROBOROS_TASK_ABS_CEILING_SEC",
    "OUROBOROS_MAIN_WEB_SEARCH",
    "OUROBOROS_WEBSEARCH_BACKEND",
})
