...
from ouroboros.host_bound_outcome import (  # split out (module ceiling); tests import these here
    ...
    _resolve_work_uncommitted_scope,
    _task_requests_uncommitted_file_deliverable,
)
...
def _store_task_result(env: Any, task: Dict[str, Any], text: str,
    ...
    try:
        ...
        if (
            ...
            and not _is_subagent
            and not _task_requests_uncommitted_file_deliverable(task)
        ):
