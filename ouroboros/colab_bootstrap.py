...
def build_colab_settings(
    ...
    *,
    ...
    for key, value in (models or {}).items():
        if key in {"OUROBOROS_MODEL", "OUROBOROS_MODEL_HEAVY", "OUROBOROS_MODEL_LIGHT", "OUROBOROS_MODEL_VISION", "OUROBOROS_MODEL_CONSCIOUSNESS", "OUROBOROS_MODEL_CHAT", "OUROBOROS_MODEL_FALLBACKS"} and value:
            settings[key] = str(value)
