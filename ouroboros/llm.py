...
class LLMClient:
    ...
    # ------------------------------------------------------------------
    # Google Generative AI (v6.103.8) — native ``generateContent`` REST,
    # NOT OpenAI-compatible. The 1M-input / 65K-output flash-class window is
    # what made this lane worth landing after OpenRouter exhausted its
    # credit pool on task c7862982 (a 100k-token deep-review attempt 402'd).
    # ------------------------------------------------------------------
    @staticmethod
