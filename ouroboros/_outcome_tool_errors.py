...
# `preflight_root_hint` (ibl-a0348d742b9b): a pre-dispatch "re-issue with this
# root" nudge — the call did not fail, so it partitions with the ok statuses.
_OK_TOOL_STATUSES = frozenset({"", "ok", "ok_autocorrected", "untyped", "preflight_root_hint"})
