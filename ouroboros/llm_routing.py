...
class _ProviderRoutingMixin:
    ...
    def _resolve_remote_target(
        ...
        if provider == "qwen":
            # Alibaba DashScope (Qwen) — OpenAI-compatible, reuses the OpenAI
            # client transport like cloudru/minimax. Base URL defaults to the
            # international endpoint; set QWEN_BASE_URL to
            ...
            return {
                ...
                "base_url": (configured("QWEN_BASE_URL", "") or "").strip() or QWEN_DEFAULT_BASE_URL,
                "default_headers": {},
                "supports_openrouter_extensions": False,
                "supports_generation_cost": False,
            }
