...
- `delegate_wait` is an event-only model sleep. Renew bounded transport windows in
  ...
  descendants and root acceptance capacity. The whole poll is READ-ONLY: it
  ...
  never change its own next answer. Vendor-internal descendants stay opaque.
