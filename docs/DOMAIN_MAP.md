...
| D10 | Git, update & release machinery | 33 | 0 |
| D11 | Gateway, server & Web UI | 51 | 0 |
| D12 | Settings & configuration | 15 | 0 |
| D13 | Safety, guards & runtime mode | 11 | 0 |
| D14 | Skills & extensions | 55 | 0 |
...
2 pinned cross-domain literal copies (baseline; shrinking is progress, new rows are red):

- `029e01f3185a1a75`: `ouroboros/tools/shell.py::_maybe_autocorrect_grep_backslash_pipe` · `ouroboros/tools/shell_grep_argv.py::_maybe_autocorrect_grep_backslash_pipe`
- `0a3522261e88ae11`: `ouroboros/tools/shell.py::_grep_has_explicit_regex_mode` · `ouroboros/tools/shell_grep_argv.py::_grep_has_explicit_regex_mode`
...
- `ouroboros/host_bound_outcome.py`
- `ouroboros/loop.py`
...
- `ouroboros/tools/shell_output_fingerprint.py`
...
- `ouroboros/_review_status_dicts.py`
...
- `ouroboros/review_cross_check.py`
...
- `ouroboros/tools/git_status_parse.py`
...
- `ouroboros/tools/review_oversized.py`
...
- `ouroboros/tools/commit_post_commit.py`
...
- `ouroboros/tools/version_release.py`
...
- `supervisor/update_semantic_overlap.py`
- `supervisor/update_source.py`
- `supervisor/update_watch.py`
...
- `ouroboros/tools/shell_and_chain.py`
- `ouroboros/tools/shell_grep_argv.py`
...
- `ouroboros/consciousness_context.py`
