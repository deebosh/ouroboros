...
| 14 | `UpdateMergePlan` | `ouroboros/gateway/contracts.py` (ok)<br>`web/modules/api_types.js` (ok) | `tests/test_gateway_parity.py` (ok)<br>`tests/test_update_apply_routing.py` (ok) |
| 15 | `ChatOutbound.review_projection` | `ouroboros/gateway/contracts.py` (ok)<br>`ouroboros/review_substrate.py` (ok) | `tests/test_contracts.py` (ok)<br>`tests/test_gateway_parity.py` (ok)<br>`tests/test_review_substrate_v2.py` (ok)<br>`web/tests/review_truth.test.js` (ok) |
| 16 | `chat_id_policy` | `ouroboros/contracts/chat_id_policy.py` (ok) | `tests/test_chat_id_policy.py` (ok) |
| 17 | `task_contract` | `ouroboros/contracts/task_contract.py` (ok) | — |
| 18 | `PluginAPI` | `ouroboros/contracts/plugin_api.py` (ok) | `tests/test_contracts.py::test_plugin_api_surface_is_frozen` (ok)<br>`tests/test_contracts.py::test_extension_route_methods_contract_matches_server_dispatch` (ok)<br>`tests/test_extension_loader.py::test_plugin_api_impl_matches_protocol` (ok) |
| 19 | `SkillManifest` | `ouroboros/contracts/skill_manifest.py` (ok) | — |
| 20 | `schema_versions` | `ouroboros/contracts/schema_versions.py` (ok) | — |
