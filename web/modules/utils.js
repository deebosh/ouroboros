...
export function renderSkillRepairPrompt(intro, diagnosticsJson) {
    ...
    return [
        ...
        '- After a fresh executable review and required grants/dependencies, test the real script, tools, routes, widget or companion. If needed for the authorized test, enable the skill.',
        ...
        '- Finish in the state requested by the owner; preserve the initial enablement intent unless the owner changes it.',
        '',
