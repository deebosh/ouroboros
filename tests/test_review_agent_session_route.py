...
# ---------------------------------------------------------------------------
# ibl-01b310c0ce18 — cross_check audit must survive _verdict_result for ALL
# methods (schema / strict / light_model_extraction), not only the light
# branch where it lived under usage['extraction']['cross_check']. Schema and
# strict used to silently drop the audit entry, breaking the audit trail that
# canonicalize_session_verdict emits in every branch when repo_root is set.
# ---------------------------------------------------------------------------
