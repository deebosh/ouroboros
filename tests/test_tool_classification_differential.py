...
_RESIDUAL_TEXT_INSPECTIONS: Mapping[str, tuple[int, str]] = MappingProxyType({
    ...
    # Fork split (ibl-500e3d3b40f2): the execution-health classification body of
    # `derive_loop_outcome` moved to this leaf, carrying its trace-text prefix
    # checks with it — redistribution out of outcomes.py, not new growth.
    "ouroboros/_outcome_axes.py": (5, "execution-health trace classification split out of outcomes.py"),
